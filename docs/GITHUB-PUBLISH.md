...
2. 推送原始碼與文件到 `main`。
3. 建立下一版 tag `v3.0.16`（上一個公開版本為 `v3.0.15`）。
4. 將 `dist\NetOptimizer-v3.0.16-win-x64.zip` 與 `dist\SHA256SUMS-v3.0.16.txt` 附加到 GitHub Release；需要時再附上 EXE、PDB 與 source ZIP。
