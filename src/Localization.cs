    ...
    internal static class Localization
    {
        private static readonly Dictionary<string, string> English =
            new Dictionary<string, string>(StringComparer.Ordinal)
            {
                ...
                { "結束", "Exit" },
                { "快速開始", "Quick start" },
                { "主要網路 A", "Primary network A" },
                { "備援網路 B", "Backup network B" },
                ...
                { "開啟進階設定視窗。", "Open the advanced settings window." },
                { "進階設定視窗開啟失敗：", "Unable to open the advanced settings window: " },
                ...
                { "自動偵測未找到任何就緒網路；主要與備援已留空。", "Automatic detection found no ready networks; primary and backup were cleared." },
                 { "請先連線 Wi‑Fi、藍牙或乙太網路，再按「重新偵測網路」。", "Connect Wi-Fi, Bluetooth, or Ethernet first, then click “Detect networks”." },
